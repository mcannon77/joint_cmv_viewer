        ...
        layers: [
  		{
                ...
                queryParameters: {
                    ...
                    layerID: 'CIP', // from operational layers
                    sublayerID: 0,
                    outFields: ['*']
                },
                attributeSearches: [
                    {
                        name: 'Search By Building Number',
                        searchFields: [
                            {
                                name: 'BuildingNumber',
                                label: 'Building Number',
                                expression: '(buildingNumber LIKE \'%[value]%\')',
