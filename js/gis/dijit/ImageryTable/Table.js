define([
    ...
    // template
    'dojo/text!./templates/ImageryTable.html',

    //i18n
    'dojo/i18n!./nls/ImageryTable',
    ...
    // css
    'xstyle/css!./css/ImageryTable.css'
    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, _GridMixin, _QueryMixin, _FeaturesMixin, _GraphicsMixin, _ToolbarMixin], {
        ...
        baseClass: 'cmvImageryTableWidget',
        ...
        postCreate: function () {
            ...
            this.imageServiceLayer = new ArcGISImageServiceLayer('https://52muhj-ws-g027/geobase/rest/services/Imagery/ACCImagery/ImageServer', {minScale: 150000});
        ...
        */
        checkSizing: function () {
            var top = 0, cStyle;
            var tbNode = this.ImageryTableToolbarDijit.domNode;
            var gridNode = this.ImageryTableGridDijit.domNode;
